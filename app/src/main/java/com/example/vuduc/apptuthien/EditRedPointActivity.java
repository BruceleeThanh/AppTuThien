...
public class EditRedPointActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        ...
        btn_chon_anh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ImagePickerUtils.showFileChooser(EditRedPointActivity.this, chooseImages, PICK_IMAGE_REQUEST);
            }
        });
    ...
    private void xuLyStartDay() {
        ...
        DatePickerDialog dialog=new DatePickerDialog(EditRedPointActivity.this, callBack,
